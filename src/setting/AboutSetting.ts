...
//关于我页面一二三段
export const aboutMeP1 = "广东工业大学 软件工程 2026届本科生";
export const aboutMeP2 = "专注于前端开发，喜欢探索新技术，用代码构建美好的数字世界 ";
export const aboutMeP3 = "在这里记录我的技术学习心得和项目经验，与大家分享交流";
...
export const mail = "mailto:2713975114@qq.com"; //邮箱配置
export const github = "https://github.com/wenhuilan"; //github网站配置
